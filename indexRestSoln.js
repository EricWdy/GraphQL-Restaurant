...
// The GraphQL queries used for the assignment
...
//   } 
// }
// mutation setRest($nm:String!,$dp:String!){
//   setrestaurant(input:{
//     name:$nm
//     description:$dp
//   }){
...
// mutation updateRest($iid:Int!,$nm:String!){
//   editrestaurant(id:$iid,name:$nm){
//     name
//     description
//   }
// }

// mutation delRest($iid: Int!) {
...
var root = {
  restaurant : (arg)=>restaurants.filter(rest=>rest.name === arg.name)[0],
